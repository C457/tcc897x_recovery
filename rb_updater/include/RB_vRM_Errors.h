...
#define  E_RB_NOT_64BIT_DELTA       RB_MAKE_ERROR(15)
#define  E_RB_BAD_ENDIANNESS		RB_MAKE_ERROR(16)
/* Resources errors */
...
#define E_RB_SOURCE_SIG_MISMATCH				RB_MAKE_ERROR(318)	/**< File signature does not match signature */
...
#define E_RB_FSIMAGE_DELTA_NOT_SUPPORTED		RB_MAKE_ERROR(0x100F6) /**< UPI does not support fsimage update */
